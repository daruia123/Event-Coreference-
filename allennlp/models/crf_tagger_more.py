...
from allennlp.modules import ConditionalRandomField1, FeedForward
from allennlp.modules.conditional_random_field1 import allowed_transitions
from allennlp.models.model import Model
from allennlp.nn import InitializerApplicator, RegularizerApplicator
import allennlp.nn.util as util
from allennlp.training.metrics import CategoricalAccuracy, SpanBasedF1Measure

@Model.register("crf_tagger_more")
class CrfTagger(Model):
    ...
    def __init__(self, vocab: Vocabulary,
                 ...
                 constraint_type: Optional[str] = None,  # "BIO"
        ...
        self.crf = ConditionalRandomField1(
    ...
    def forward(self,
        ...
        if tags is not None:
            ...
            for metric in self.metircs.values():

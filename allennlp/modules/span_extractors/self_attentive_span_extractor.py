...
class SelfAttentiveSpanExtractor(SpanExtractor):
    """
    Computes span representations by generating an unnormalized attention（非标准化） score for each
    ...
    def forward(self,
        ...
        global_attention_logits = self._global_attention(contextualized_embedding)
        ...
        # Shape: (batch_size * num_spans * max_batch_span_width)  # 将span_indices的维度摊平
